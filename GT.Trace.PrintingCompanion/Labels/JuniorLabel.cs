...
namespace GT.Trace.PrintingCompanion.Labels
{
    ...
    {
        public JuniorLabel(string po, string julianDate, string customerPartNo, string revision, string partNo, string customer, string partDescription, DateTime date, int quantity, string lineCode, long masterID, string approver, DateTime? approvalDate)
        {
            InitializeComponent();
